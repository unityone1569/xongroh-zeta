  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          'bg-light-2 text-dark-1 hover:bg-primary hover:text-dark-3 focus:bg-primary focus:text-dark-3 rounded-l-md rounded-r-md',
        today: 'bg-light-4 text-accent-foreground',
        outside:
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'w-[48px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-light-1 focus:text-dark-1 [&::-webkit-inner-spin-button]:appearance-none',
          className
        )}
