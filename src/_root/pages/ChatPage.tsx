...
const EncryptionWarning = () => (
  <div className="bg-dark-3 p-4 mb-4 w-full rounded-lg">
    <div className="flex items-center text-justify justify-center">
      ...
      <div className="ml-3">
        <p className="subtle-normal">
          <strong>Security Notice:</strong> Messages in this chat are encrypted. Please send sensitive information with caution.
        </p>
      </div>
    </div>
  </div>
